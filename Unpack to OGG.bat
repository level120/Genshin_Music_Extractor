...
FOR %%n IN ("PCK_Repo\*.PCK") DO (
    ...
    FOR %%d IN ("Wwise-Unpacker\Tools\Decoding\*.OGG") DO ("Wwise-Unpacker\Tools\revorb.exe" "%%d" & MOVE "%%d" "Wwise-Unpacker\OGG")
    ...
    FOR %%b IN ("Wwise-Unpacker\OGG\*.ogg") DO (MOVE "%%b" "Music")
